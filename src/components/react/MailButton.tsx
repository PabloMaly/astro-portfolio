...
export const MailButton: FC<MailButtonProps> = ({ email }) => {
    ...
    return (
        <button
            type="button"
            onClick={handleCopy}
            className="flex items-center gap-2 px-4 py-2 bg-white rounded-full shadow-md hover:shadow-lg transition-all text-sm cursor-pointer relative overflow-hidden active:scale-95">
            <svg
                className="w-6 h-6"
                viewBox="0 0 24 24"
                fill="currentColor"
            ...
            <span className="copy-text transition-all duration-200">
